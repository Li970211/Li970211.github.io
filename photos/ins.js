    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://github.com/Li970211/Li970211.github.io/tree/master/photos' + data.link[i] + '.min.jpg';
          var src = 'https://github.com/Li970211/Li970211.github.io/tree/master/photos' + data.link[i];
